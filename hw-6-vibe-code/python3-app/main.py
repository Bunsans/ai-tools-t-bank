...
class HospitalHandler(BaseRedisHandler):
    ...
    def post(self):
        ...
        logging.debug(
            f"Hospital creation: name={name}, address={address}, beds={beds_number}, phone={phone}"
        )
...
class PatientHandler(BaseRedisHandler):
    ...
    def post(self):
        ...
        logging.debug(
            f"Patient creation: surname={surname}, born_date={born_date}, sex={sex}, mpn={mpn}"
        )
...
class DiagnosisHandler(BaseRedisHandler):
    ...
    def post(self):
        ...
        logging.debug(
            f"Diagnosis creation: patient_ID={patient_ID}, type={diagnosis_type}, information={information}"
        )
...
class DoctorPatientHandler(BaseRedisHandler):
    ...
    def post(self):
        ...
        logging.debug(
            f"Doctor-patient link: doctor_ID={doctor_ID}, patient_ID={patient_ID}"
        )
